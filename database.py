...
class Content(Base):
    ...
    required_optional   = Column(String(10))
    ...
    filming_consent     = Column(String(10))
    shooting_date       = Column(Date)
    shooting_time       = Column(String(50))
    shooting_format     = Column(String(100))
    location            = Column(String(200))
    has_quiz            = Column(String(10))
    quiz_count          = Column(Integer)
    materials_supply    = Column(String(10))
    video_marking       = Column(String(10))
